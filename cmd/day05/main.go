...
func main() {
	...
	solver, err := day05.NewDay5Solver(logger)

	if err != nil {
		logger.Fatal("failed to instantiate day 5 problem solver", zap.Error(err))
	}
	...
	logger.Info("solved day 5 problem", zap.Int("numOfFreshIngredients", solution.NumOfFreshIngredients), zap.Int("numOfAvailableIngredients", solution.NumOfAvailableIngredients))
}
